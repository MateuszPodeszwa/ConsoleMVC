...
public class ViewSourceGenerator : IIncrementalGenerator
{
    public void Initialize(IncrementalGeneratorInitializationContext context)
    {
        ...
        // Get the RootNamespace from the consuming project
        ...
        // Combine each view file with the root namespace
        ...
        context.RegisterSourceOutput(viewsWithNamespace, static (ctx, pair) =>
        {
            ...
            // Use the consuming project's RootNamespace for the generated views
